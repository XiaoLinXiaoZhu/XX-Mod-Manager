<template>
  <!-- -帮助页面 -->
  <div id="help-section" style="display: flex;flex-direction: row;height: 100%;width: 100%;overflow: hidden;">
    <leftMenu :tabs="tabs" :translatedTabs="translatedTabs" @tabChange="handleTabChange">
    </leftMenu>
    <div id="help-dialog-cn" v-if="language === 'zh_cn'">
      <div slot="headline" class="font-hongmeng"
        style="height: calc(100% - 35px);display: flex;padding: 0px;flex-direction: column;">
        ...
        <div id="help-dialog-container">
          ...
          <div id="help-content" class="OO-box">
            ...
            <div id="help-dialog-help-mod-en" class="help-dialog-tab" style="overflow: auto;">
              ...
              <div class="OO-box OO-shade-box">
                ...
                <p>1. Drag the mod folder into the main window, and it will automatically move your mod folder to the
                  modSource, but dragging actions will be disabled due to security restrictions when in
              ...
              <div class="OO-box OO-shade-box">
                <p>1. Click on a mod in the mod list, and its information will be displayed on the right. Click the Edit
                  Mod Information button in the right menu, and a dialog box for editing mod information will pop up.
                  Fill in the mod information as prompted</p>
                <p>2. Right-click on a mod in the mod list, and a dialog box for editing mod information will pop up.
                  Fill in the mod information as prompted</p>
                <p>Afterward, your mod information will be saved to the modSource, and you can see your mod
                  information in the mod list</p>
              </div>
            ...
            <div id="help-dialog-help-multiple-games-en" class="help-dialog-tab" style="overflow: auto;">
              ...
              <div class="OO-box OO-shade-box">
                ...
                <p>2. Set the location of the configuration folder in the "Switch Configuration" section of the settings
                  page</p>
                <p>3. Click "Save current configuration to configuration folder" to save the current configuration to
              ...
              <div class="OO-box OO-shade-box">
                ...
                <p>Additionally, you can enable the automatic prompt to switch configurations. This way, when the
                  program starts, it will ask you to choose which configuration folder to use, adapting to different
                  games.</p>
              </div>
            </div>
            ...
            <div id="help-dialog-help-auto-en" class="help-dialog-tab" style="overflow: auto;">
              ...
              <div class="OO-box OO-shade-box">
                <p>When the program starts, it will automatically launch the game and modLoader, but this requires
                  setting the game directory and modLoader directory in the advanced settings.</p>
              </div>
              ...
              <div class="OO-box OO-shade-box">
                <p>When the program starts, it will use administrator privileges. This way, when the game is launched
                  automatically, it will also start with administrator privileges without prompting a UAC dialog.
                  However, using administrator mode will disable dragging actions, and importing mods and setting mod
                  cover images by dragging will be disabled.
                </p>
              </div>
            </div>
            ...
            <div id="help-dialog-help-trouble-en" class="help-dialog-tab" style="overflow: auto;">
              ...
              <div class="OO-box OO-shade-box">
                ...
                <p>3. Press Ctrl + Shift + I to open the console and view error messages, which may help you identify
                  the problem</p>
