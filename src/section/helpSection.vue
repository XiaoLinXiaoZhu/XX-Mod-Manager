...
`;
const _configModLoaderContentCn = `# 加载mod
...
const _loadContentCn = `# 在配置mod加载器之后
...
`;
const _multipleGamesContentCn = `# 适配多个游戏
...
const _explainContentEn = `# Prerequisites
...
const _importContentEn = `# Import Mods
...
const _configModLoaderContentEn = `# Loading Mods
...
const _loadContentEn = `# After Configuring the Mod Loader
...
const _configContentEn = `# Mod Information
...
const _presetContentEn = `# Preset Function
...
const _autoContentEn = `# Automation
...
const _multipleGamesContentEn = `# Multi-Game Support
...
const _troubleContentEn = `# Troubleshooting
