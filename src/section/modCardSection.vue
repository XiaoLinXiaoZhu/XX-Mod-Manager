<template>
    ...
    <div class="bottom">
        <div class="bottom-left">
            <s-tooltip>
                <!-- -刷新按钮 -->
                <s-icon-button @click="handleRefreshButtonClicked" slot="trigger"
                    class="OO-button" style="color: var(--s-color-on-surface);margin: 0 10px 0 0;transform: scale(0.95);">
                    <s-icon type="refresh"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                            <path
