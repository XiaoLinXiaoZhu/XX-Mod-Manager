...
function u(e) {
	((e) => "MessagePort" === e.constructor.name)(e) && e.close();
}
function l(e) {
...
function f(e, n = [], o = () => {}) {
	...
	const i = new Proxy(o, {
		...
		apply(_t, _o, i) {
			...
			if ("bind" === s) return f(e, n.slice(0, -1));
			const [u, c] = m(i);
			return g(
				e,
				{
...
class y {
	...
	*entries(e = !1, r = null) {
	...
	async _loadFile(e) {
		...
		return (
			this._wasmModule.HEAPU8.set(t, n),
			{
				ptr: n,
				length: t.length,
			}
...
class E {
	...
	async write(e, r, t, n = null) {
		const o = e.reduce((e, { file: r }) => e + r.size, 0) + 512;
		...
		if (0 !== u || 0 !== l) throw new Error(this._runCode.getError(s));
	...
	readNumberFromPointer(e) {
		...
		let n = null;
		if (4 === r) n = new Uint32Array(t)[0];
		else {
			if (8 !== r) throw Error(`Unexpected size of size_t: ${r}`);
...
var b,
	k =
		...
		async (e = {}) => {
			...
			var f = "";
			if (alwaysFalseh) {
				const { createRequire: e } = await import("node:module");
			...
			var w,
				g,
				_ = n.print || console.log,
				y = n.printErr || console.error;
			Object.assign(n, s),
				(s = null),
			...
			function x(_e) {
				if ((U--, n.monitorRunDependencies?.(U), 0 === U && z)) {
					var r = z;
					(z = null), r();
				}
			}
			...
			var N,
				...
				StartWithFile = (e) => e.startsWith("file://");
			function W(e) {
			...
			function handleLocalArchive(e, r, t) {
				return ((e) => {
					...
					.then((e) => e)
					.then(t, (e) => {
						y(`failed to asynchronously prepare wasm: ${e}`, e), O(e);
					});
			}
			function $(e) {
			...
			n.locateFile
				? StartWithData((N = "libarchive.wasm")) ||
			...
			var oe = {
					...
					stream_ops: {
						...
						read(e, r, t, n, _o) {
							if (!e.tty?.ops.get_char) throw new le.ErrnoError(60);
						...
						write(e, r, t, n, _o) {
							if (!e.tty?.ops.put_char) throw new le.ErrnoError(60);
							try {
					...
					default_tty_ops: {
						...
						ioctl_tcsets: (_e, _r, _t) => 0,
						ioctl_tiocgwinsz: (_e) => [24, 80],
					},
					default_tty1_ops: {
						put_char(e, r) {
							null === r || 10 === r
				...
				ie = {
					ops_table: null,
					mount: (_e) => ie.createNode(null, "/", 16895, 0),
					createNode(e, r, t, n) {
						...
						return (
							le.isDir(o.mode)
								? ((o.node_ops = ie.ops_table.dir.node),
									(o.stream_ops = ie.ops_table.dir.stream),
									(o.contents = {}))
								: le.isFile(o.mode)
									? ((o.node_ops = ie.ops_table.file.node),
										(o.stream_ops = ie.ops_table.file.stream),
										(o.usedBytes = 0),
										(o.contents = null))
									: le.isLink(o.mode)
										? ((o.node_ops = ie.ops_table.link.node),
											(o.stream_ops = ie.ops_table.link.stream))
										: le.isChrdev(o.mode) &&
											((o.node_ops = ie.ops_table.chrdev.node),
					...
					node_ops: {
						...
						rename(e, r, t) {
							if (le.isDir(e.mode)) {
								...
								if (n) for (var _o in n.contents) throw new le.ErrnoError(55);
							}
						...
						rmdir(e, r) {
							...
							for (var _n in t.contents) throw new le.ErrnoError(55);
							delete e.contents[r], (e.timestamp = Date.now());
						},
						readdir(e) {
							var r = [".", ".."];
					...
					stream_ops: {
						...
						msync: (e, r, t, n, _o) => (
							ie.stream_ops.write(e, r, 0, n, t, !1), 0
						),
					},
				},
				se = n.preloadPlugins || [],
				...
				le = {
					...
					mount(e, r, t) {
						...
						return (
							...
							o
								? (le.root = u)
								: n && ((n.mounted = s), n.mount?.mounts.push(s)),
							u
						);
					},
					unmount(e) {
					...
					createDataFile(e, r, t, n, o, a) {
						...
						if (t) {
							...
							le.chmod(u, 146 | s);
							var h = le.open(u, 577);
							le.write(h, t, 0, t.length, 0, a), le.close(h), le.chmod(u, s);
						}
					},
					...
					createLazyFile(e, r, t, n, o) {
						...
						return (
							...
							(l.read = (e, r, t, n, o) => (
								le.forceLoadFile(u), c(e, r, t, n, o)
							)),
							(l.mmap = (e, r, t, _n, _o) => {
								le.forceLoadFile(u);
								var a = ae();
				...
				de = {
					...
					doStat(e, r, t) {
						try {
							...
							if (e?.node && Z.normalize(r) !== Z.normalize(le.getPath(e.node)))
								return -54;
							throw e;
						}
						(F[t >> 2] = n.dev),
				...
				fe = {
					...
					mount: (_e) => le.createNode(null, "/", 16895, 0),
					createPipe() {
						var e = {
							buckets: [],
							refcnt: 2,
					...
					stream_ops: {
						...
						read(e, r, t, n, _o) {
							...
							if (n <= 0) return 0;
							if (0 === i) throw new le.ErrnoError(6);
							var c = Math.min(i, n),
								d = c,
								h = 0;
						...
						write(e, r, t, n, _o) {
							...
							if (l >= s) return u.buffer.set(i, u.offset), (u.offset += s), s;
							l > 0 &&
								(u.buffer.set(i.subarray(0, l), u.offset),
								(u.offset += l),
								(i = i.subarray(l, i.byteLength)));
							for (
								var c = (i.byteLength / fe.BUCKET_BUFFER_SIZE) | 0,
									d = i.byteLength % fe.BUCKET_BUFFER_SIZE,
									h = 0;
								h < c;
								h++
							) {
				...
				Pe = (e, r, t, n, _o) => {
					...
					if (n)
						for (var l = 0; l < n.length; l++) {
							var c = a[t[l]];
							c ? (0 === u && (u = je()), (s[l] = c(n[l]))) : (s[l] = n[l]);
						}
					var d = i.apply(null, s);
					return (d = ((e) => (
						0 !== u && Ie(u),
						((e) =>
							"string" === r ? ce(e) : "boolean" === r ? Boolean(e) : e)(e)
					))(d));
				},
				Te = function (e, r, t, n) {
					e || (e = this),
			...
			var ze = {
					...
					m: (e) => {
						var r = (() => {
							var r = new Date(
								...
								s = Math.min(i, a);
							if (t < 0) F[(e + 32) >> 2] = Number(a !== i && s === n);
							else if (t > 0 !== (s === n)) {
								var u = Math.max(i, a),
									l = t > 0 ? s : u;
							...
							(F[(e + 28) >> 2] = c),
								...
								(F[(e + 20) >> 2] = r.getYear());
							var d = r.getTime();
							return Number.isNaN(d) ? (he(61), -1) : d / 1e3;
						})();
						return (
							Be(
								((j = r),
					...
					f: (e, r, t, n) => {
						...
						for (var u in ((i = i.replace(/%%/g, "\0\0")), v))
				...
				Le = (() => {
					...
					return (
						...
						e || StartWithData(wasmPath) || StartWithFile(wasmPath)
			...
			(n._archive_close = (e) => (n._archive_close = Le.L)(e)),
				(n._start_archive_write = (e, r, t, o, a, i) =>
					(n._start_archive_write = Le.M)(e, r, t, o, a, i)),
			...
			(n._archive_entry_birthtime_nsec = (e) =>
				(n._archive_entry_birthtime_nsec = Le.R)(e)),
				(n._archive_entry_filetype = (e) =>
					(n._archive_entry_filetype = Le.S)(e)),
				(n._archive_entry_mtime_nsec = (e) =>
					(n._archive_entry_mtime_nsec = Le.T)(e)),
				(n._archive_entry_pathname = (e) =>
					(n._archive_entry_pathname = Le.U)(e)),
				(n._archive_entry_pathname_utf8 = (e) =>
					(n._archive_entry_pathname_utf8 = Le.V)(e)),
				(n._archive_entry_size = (e) => (n._archive_entry_size = Le.W)(e)),
				(n._archive_entry_is_encrypted = (e) =>
					(n._archive_entry_is_encrypted = Le.X)(e)),
				(n._archive_read_has_encrypted_entries = (e) =>
					(n._archive_read_has_encrypted_entries = Le.Y)(e)),
				(n._archive_read_data_skip = (e) =>
					(n._archive_read_data_skip = Le.Z)(e)),
