    ...
    t.addEventListener("message", (function i(l) {
        ...
        if (!function(e, r) {
            for (const t of e) {
                if (r === t || "*" === t)
                    return !0;
                if (t instanceof RegExp && t.test(r))
                    return !0
            }
            return !1
        }(a, l.origin))
            return void console.warn(`Invalid origin '${l.origin}' for comlink proxy`);
        const {id: c, type: d, path: h} = Object.assign({
            path: []
        }, l.data)
        ...
        Promise.resolve(m).catch((e => ({
            ...
            "RELEASE" === d && (t.removeEventListener("message", i),
            u(t),
...
function m(e) {
    const r = e.map(v);
    return [r.map((e => e[0])), (t = r.map((e => e[1])),
...
function g(e, r, t) {
    return new Promise((n => {
        ...
        e.addEventListener("message", (function r(t) {
            t.data && t.data.id && t.data.id === o && (e.removeEventListener("message", r),
            n(t.data))
        }
        )),
        e.start && e.start(),
...
class y {
    ...
    async open(e) {
        null !== this._file && (console.warn("Closing previous file"),
        this.close());
        const r = await this._loadFile(e);
        this._fileLength = r.length,
        this._filePtr = r.ptr
    }
    close() {
    ...
    hasEncryptedData() {
        this._archive = this._runCode.openArchive(this._filePtr, this._fileLength, this._passphrase, this._locale),
    ...
    *entries(e=!1, r=null) {
        let t;
        for (this._archive = this._runCode.openArchive(this._filePtr, this._fileLength, this._passphrase, this._locale); t = this._runCode.getNextEntry(this._archive),
        0 !== t; ) {
            const n = {
    ...
    async _loadFile(e) {
        ...
        return this._wasmModule.HEAPU8.set(t, n),
        {
            ptr: n,
            length: t.length
        }
...
class E {
    ...
    async write(e, r, t, n=null) {
        let o = e.reduce(( (e, {file: r}) => e + r.size), 0) + 512;
        const a = this._runCode.malloc(o)
          , i = this._runCode.malloc(this._runCode.sizeOfSizeT())
          , s = this._runCode.startArchiveWrite(r, t, a, o, i, n);
        for (const {file: r, pathname: t} of e) {
            const e = await this._loadFile(r);
            this._runCode.writeArchiveFile(s, t || r.name, e.length, e.ptr),
            this._runCode.free(e.ptr)
        }
        const u = this._runCode.closeArchiveWrite(s)
          , l = this._runCode.freeArchiveWrite(s);
        if (0 !== u || 0 !== l)
            throw new Error(this._runCode.getError(s));
        const c = this.readNumberFromPointer(i);
        return this._wasmModule.HEAPU8.slice(a, a + c)
    }
    async _loadFile(e) {
        const r = await e.arrayBuffer()
          , t = new Uint8Array(r)
    ...
    readNumberFromPointer(e) {
        const r = this._runCode.sizeOfSizeT()
          , t = this._wasmModule.HEAPU8.slice(e, e + r);
        let n = null;
        if (4 == r)
            n = new Uint32Array(t)[0];
        else {
            if (8 != r)
                throw Error("Unexpected size of size_t: " + r);
            n = new BigUint64Array(t)[0]
        }
        return n
    }
}
var b, k = (b = import.meta.url,
async function(e={}) {
    var r, t, n = e;
    ...
    var o, a, i, s = Object.assign({}, n), u = "./this.program", l = (e, r) => {
        throw r
    }
    , c = "object" == typeof window
    var alwaysTrue = true;
    var alwaysFalseh = false;
    var f = "";
    if (alwaysFalseh) {
        ...
        var m = e(import.meta.url)
          , p = m("fs")
          , v = m("path");
        f = alwaysTrue ? v.dirname(f) + "/" : m("url").fileURLToPath(new URL("./",import.meta.url)),
        o = (e, r) => (e = StartWithFile(e) ? new URL(e) : v.normalize(e),
        ...
        ,
        a = (e, r, t, n=!0) => {
            e = StartWithFile(e) ? new URL(e) : v.normalize(e),
        ...
        ,
        !n.thisProgram && process.argv.length > 1 && (u = process.argv[1].replace(/\\/g, "/")),
        ...
        (c || alwaysTrue) && (alwaysTrue ? f = self.location.href : "undefined" != typeof document && document.currentScript && (f = document.currentScript.src),
        b && (f = b),
        f = 0 !== f.indexOf("blob:") ? f.substr(0, f.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "",
        o = e => {
    ...
    var w, g, _ = n.print || console.log, y = n.printErr || console.error;
    Object.assign(n, s),
    s = null,
    ...
    var N, B, j, I, StartWithData = e => e.startsWith("data:application/octet-stream;base64,"), StartWithFile = e => e.startsWith("file://");
    function W(e) {
        if (e == N && w)
    ...
    function handleLocalArchive(e, r, t) {
        return function(e) {
            if (!w && (c || alwaysTrue)) {
                if ("function" == typeof fetch && !StartWithFile(e))
                    return fetch(e, {
            ...
            y(`failed to asynchronously prepare wasm: ${e}`,e),
            O(e)
        }
        ))
    }
    ...
    n.locateFile ? StartWithData(N = "libarchive.wasm") || (B = N,
    N = n.locateFile ? n.locateFile(B, f) : f + B) : N = new URL("libarchive.wasm",import.meta.url).href;
    var q = e => {
        for (; e.length > 0; )
            e.shift()(n)
    }
      ...
      , Z = {
        ...
        normalize: e => {
            var r = Z.isAbs(e)
              , t = "/" === e.substr(-1);
            return (e = Z.normalizeArray(e.split("/").filter((e => !!e)), !r).join("/")) || r || (e = "."),
            e && t && (e += "/"),
            (r ? "/" : "") + e
        }
        ,
      ...
      , V = {
        ...
        relative: (e, r) => {
            ...
            e = V.resolve(e).substr(1),
            r = V.resolve(r).substr(1);
      ...
      , Q = (e, r, t) => {
        for (var n = r + t, o = r; e[o] && !(o >= n); )
            ++o;
        if (o - r > 16 && e.buffer && J)
            return J.decode(e.subarray(r, o));
        for (var a = ""; r < o; ) {
            var i = e[r++];
            if (128 & i) {
                var s = 63 & e[r++];
    ...
    var oe = {
        ...
        default_tty_ops: {
            ...
            put_char(e, r) {
                null === r || 10 === r ? (_(Q(e.output, 0)),
                e.output = []) : 0 != r && e.output.push(r)
            },
            fsync(e) {
                e.output && e.output.length > 0 && (_(Q(e.output, 0)),
                e.output = [])
            },
            ioctl_tcgets: e => ({
                c_iflag: 25856,
        ...
        default_tty1_ops: {
            put_char(e, r) {
                null === r || 10 === r ? (y(Q(e.output, 0)),
                e.output = []) : 0 != r && e.output.push(r)
            },
            fsync(e) {
                e.output && e.output.length > 0 && (y(Q(e.output, 0)),
                e.output = [])
            }
        }
    }
      ...
      , ie = {
        ...
        createNode(e, r, t, n) {
            ...
            return le.isDir(o.mode) ? (o.node_ops = ie.ops_table.dir.node,
            o.stream_ops = ie.ops_table.dir.stream,
            o.contents = {}) : le.isFile(o.mode) ? (o.node_ops = ie.ops_table.file.node,
            o.stream_ops = ie.ops_table.file.stream,
            o.usedBytes = 0,
            o.contents = null) : le.isLink(o.mode) ? (o.node_ops = ie.ops_table.link.node,
            o.stream_ops = ie.ops_table.link.stream) : le.isChrdev(o.mode) && (o.node_ops = ie.ops_table.chrdev.node,
            o.stream_ops = ie.ops_table.chrdev.stream),
        ...
        node_ops: {
            getattr(e) {
                var r = {};
                return r.dev = le.isChrdev(e.mode) ? e.id : 1,
                r.ino = e.id,
                r.mode = e.mode,
                r.nlink = 1,
                r.uid = 0,
                r.gid = 0,
                r.rdev = e.rdev,
                le.isDir(e.mode) ? r.size = 4096 : le.isFile(e.mode) ? r.size = e.usedBytes : le.isLink(e.mode) ? r.size = e.link.length : r.size = 0,
            ...
            setattr(e, r) {
                ...
                void 0 !== r.size && ie.resizeFileStorage(e, r.size)
            },
            lookup(e, r) {
                throw le.genericErrors[44]
            },
            mknod: (e, r, t, n) => ie.createNode(e, r, t, n),
            rename(e, r, t) {
                if (le.isDir(e.mode)) {
                    var n;
                    try {
            ...
            readdir(e) {
                var r = [".", ".."];
                for (var t of Object.keys(e.contents))
                    r.push(t);
                return r
            },
            symlink(e, r, t) {
        ...
        stream_ops: {
            ...
            llseek(e, r, t) {
                var n = r;
                if (1 === t ? n += e.position : 2 === t && le.isFile(e.node.mode) && (n += e.node.usedBytes),
                n < 0)
                    throw new le.ErrnoError(28);
                return n
            },
            allocate(e, r, t) {
                ie.expandFileStorage(e.node, r + t),
                e.node.usedBytes = Math.max(e.node.usedBytes, r + t)
            },
            mmap(e, r, t, n, o) {
                if (!le.isFile(e.node.mode))
                    throw new le.ErrnoError(43);
                var a, i, s = e.node.contents;
                if (2 & o || s.buffer !== E.buffer) {
                    if ((t > 0 || t + r < s.length) && (s = s.subarray ? s.subarray(t, t + r) : Array.prototype.slice.call(s, t, t + r)),
                    i = !0,
                    !(a = ae()))
            ...
            msync: (e, r, t, n, o) => (ie.stream_ops.write(e, r, 0, n, t, !1),
            0)
        }
    }
      , se = n.preloadPlugins || []
      ...
      , le = {
        ...
        lookupPath(e, r={}) {
            ...
            for (var t = e.split("/").filter((e => !!e)), n = le.root, o = "/", a = 0; a < t.length; a++) {
                var i = a === t.length - 1;
                if (i && r.parent)
                    break;
                if (n = le.lookupNode(n, t[a]),
                o = Z.join2(o, t[a]),
                le.isMountpoint(n) && (!i || i && r.follow_mount) && (n = n.mounted.root),
                !i || r.follow)
                    for (var s = 0; le.isLink(n.mode); ) {
                        var u = le.readlink(o);
                        if (o = V.resolve(Z.dirname(o), u),
                        n = le.lookupPath(o, {
        ...
        hashAddNode(e) {
            ...
            e.name_next = le.nameTable[r],
            le.nameTable[r] = e
        },
        hashRemoveNode(e) {
            var r = le.hashName(e.parent.id, e.name);
            if (le.nameTable[r] === e)
                le.nameTable[r] = e.name_next;
            else
        ...
        mayDelete(e, r, t) {
            ...
            if (t) {
                if (!le.isDir(n.mode))
                    return 54;
                if (le.isRoot(n) || le.getPath(n) === le.cwd())
                    return 10
            } else if (le.isDir(n.mode))
                return 31;
            return 0
        },
        ...
        getStreamChecked(e) {
            ...
            if (!r)
                throw new le.ErrnoError(8);
            return r
        },
        getStream: e => le.streams[e],
        createStream: (e, r=-1) => (le.FSStream || (le.FSStream = function() {
            this.shared = {}
        }
        ,
        ...
        syncfs(e, r) {
            ...
            e = !1),
            le.syncFSRequests++,
            le.syncFSRequests > 1 && y(`warning: ${le.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
            var t = le.getMounts(le.root.mount)
              , n = 0;
            function o(e) {
                return le.syncFSRequests--,
                r(e)
            }
            function a(e) {
                if (e)
        ...
        unmount(e) {
            ...
            Object.keys(le.nameTable).forEach((e => {
                for (var r = le.nameTable[e]; r; ) {
                    var t = r.name_next;
                    o.includes(r.mount) && le.destroyNode(r),
                    r = t
                }
            }
            )),
        ...
        symlink(e, r) {
            ...
            var n = Z.basename(r)
              , o = le.mayCreate(t, n);
            if (o)
                throw new le.ErrnoError(o);
            if (!t.node_ops.symlink)
                throw new le.ErrnoError(63);
            return t.node_ops.symlink(t, n, e)
        },
        rename(e, r) {
            var t, n, o = Z.dirname(e), a = Z.dirname(r), i = Z.basename(e), s = Z.basename(r);
            ...
            !t || !n)
                throw new le.ErrnoError(44);
            if (t.mount !== n.mount)
                throw new le.ErrnoError(75);
            var u, l = le.lookupNode(t, i), c = V.relative(e, a);
            if ("." !== c.charAt(0))
                throw new le.ErrnoError(28);
            ...
            if (l !== u) {
                var d = le.isDir(l.mode)
                  , h = le.mayDelete(t, i, d);
                if (h)
                    throw new le.ErrnoError(h);
                if (h = u ? le.mayDelete(n, s, d) : le.mayCreate(n, s))
                    throw new le.ErrnoError(h);
        ...
        truncate(e, r) {
            ...
            if (!(t = "string" == typeof e ? le.lookupPath(e, {
                ...
                throw new le.ErrnoError(63);
            if (le.isDir(t.mode))
                throw new le.ErrnoError(31);
            if (!le.isFile(t.mode))
                throw new le.ErrnoError(28);
            var n = le.nodePermissions(t, "w");
            if (n)
                throw new le.ErrnoError(n);
        ...
        open(e, r, t) {
            ...
            if (64 & r)
                if (o) {
                    if (128 & r)
                        throw new le.ErrnoError(20)
                } else
                    o = le.mknod(e, t, 0),
                    a = !0;
            if (!o)
                throw new le.ErrnoError(44);
            if (le.isChrdev(o.mode) && (r &= -513),
            65536 & r && !le.isDir(o.mode))
                throw new le.ErrnoError(54);
            if (!a) {
                var i = le.mayOpen(o, r);
                if (i)
                    throw new le.ErrnoError(i)
            }
            512 & r && !a && le.truncate(o, 0),
            r &= -131713;
            ...
            !n.logReadFiles || 1 & r || (le.readFiles || (le.readFiles = {}),
        ...
        readFile(e, r={}) {
            ...
            var t, n = le.open(e, r.flags), o = le.stat(e).size, a = new Uint8Array(o);
            return le.read(n, a, 0, o, 0),
            "utf8" === r.encoding ? t = Q(a, 0) : "binary" === r.encoding && (t = a),
            le.close(n),
            t
        },
        writeFile(e, r, t={}) {
        ...
        chdir(e) {
            ...
            if (null === r.node)
                throw new le.ErrnoError(44);
            if (!le.isDir(r.node.mode))
                throw new le.ErrnoError(54);
            var t = le.nodePermissions(r.node, "x");
            if (t)
                throw new le.ErrnoError(t);
            le.currentPath = r.path
        },
        createDefaultDirectories() {
            le.mkdir("/tmp"),
            le.mkdir("/home"),
            le.mkdir("/home/web_user")
        },
        ...
        createStandardStreams() {
            n.stdin ? le.createDevice("/dev", "stdin", n.stdin) : le.symlink("/dev/tty", "/dev/stdin"),
            n.stdout ? le.createDevice("/dev", "stdout", null, n.stdout) : le.symlink("/dev/tty", "/dev/stdout"),
            n.stderr ? le.createDevice("/dev", "stderr", null, n.stderr) : le.symlink("/dev/tty1", "/dev/stderr"),
            le.open("/dev/stdin", 0),
        ...
        createDataFile(e, r, t, n, o, a) {
            var i = r;
            e && (e = "string" == typeof e ? e : le.getPath(e),
            i = r ? Z.join2(e, r) : e);
            var s = ue(n, o)
              , u = le.create(i, s);
            if (t) {
        ...
        createLazyFile(e, r, t, n, o) {
            ...
            a.prototype.cacheLength = function() {
                ...
                s.setDataGetter((e => {
                    ...
                    void 0 === s.chunks[e] && (s.chunks[e] = ( (e, r) => {
                        ...
                        return void 0 !== o.response ? new Uint8Array(o.response || []) : ne(o.responseText || "", !0)
                    }
                    )(r, o)),
                    void 0 === s.chunks[e])
                ...
                i = n,
                _("LazyFiles on gzip forces download of the whole file when length is accessed")),
                this._length = n,
                this._chunkSize = i,
                this.lengthKnown = !0
            }
            ...
            return Object.keys(u.stream_ops).forEach((e => {
                ...
                l[e] = function() {
                    return le.forceLoadFile(u),
                    r.apply(null, arguments)
                }
            }
            )),
            l.read = (e, r, t, n, o) => (le.forceLoadFile(u),
            c(e, r, t, n, o)),
            l.mmap = (e, r, t, n, o) => {
                le.forceLoadFile(u);
                var a = ae();
      ...
      , de = {
        ...
        calculateAt(e, r, t) {
            if (Z.isAbs(r))
                return r;
            var n;
            if (n = -100 === e ? le.cwd() : de.getStreamFromFD(e).path,
            0 == r.length) {
                if (!t)
                    throw new le.ErrnoError(44);
                return n
        ...
        doStat(e, r, t) {
            try {
                ...
                if (e && e.node && Z.normalize(r) !== Z.normalize(le.getPath(e.node)))
                    return -54;
                throw e
            }
            F[t >> 2] = n.dev,
            ...
            F[t + 20 >> 2] = n.rdev,
            I = [n.size >>> 0, (j = n.size,
            +Math.abs(j) >= 1 ? j > 0 ? +Math.floor(j / 4294967296) >>> 0 : ~~+Math.ceil((j - +(~~j >>> 0)) / 4294967296) >>> 0 : 0)],
            F[t + 24 >> 2] = I[0],
            F[t + 28 >> 2] = I[1],
            F[t + 32 >> 2] = 4096,
            F[t + 36 >> 2] = n.blocks;
            var o = n.atime.getTime()
              , a = n.mtime.getTime()
              , i = n.ctime.getTime();
            return I = [Math.floor(o / 1e3) >>> 0, (j = Math.floor(o / 1e3),
            +Math.abs(j) >= 1 ? j > 0 ? +Math.floor(j / 4294967296) >>> 0 : ~~+Math.ceil((j - +(~~j >>> 0)) / 4294967296) >>> 0 : 0)],
            F[t + 40 >> 2] = I[0],
            F[t + 44 >> 2] = I[1],
            D[t + 48 >> 2] = o % 1e3 * 1e3,
            I = [Math.floor(a / 1e3) >>> 0, (j = Math.floor(a / 1e3),
            +Math.abs(j) >= 1 ? j > 0 ? +Math.floor(j / 4294967296) >>> 0 : ~~+Math.ceil((j - +(~~j >>> 0)) / 4294967296) >>> 0 : 0)],
            F[t + 56 >> 2] = I[0],
            F[t + 60 >> 2] = I[1],
            D[t + 64 >> 2] = a % 1e3 * 1e3,
            I = [Math.floor(i / 1e3) >>> 0, (j = Math.floor(i / 1e3),
            +Math.abs(j) >= 1 ? j > 0 ? +Math.floor(j / 4294967296) >>> 0 : ~~+Math.ceil((j - +(~~j >>> 0)) / 4294967296) >>> 0 : 0)],
            F[t + 72 >> 2] = I[0],
            F[t + 76 >> 2] = I[1],
            D[t + 80 >> 2] = i % 1e3 * 1e3,
    ...
    e)
      , fe = {
        ...
        stream_ops: {
            ...
            read(e, r, t, n, o) {
                ...
                return h && h == a.buckets.length && (h--,
                a.buckets[h].offset = 0,
                a.buckets[h].roffset = 0),
            ...
            write(e, r, t, n, o) {
                ...
                if (l >= s)
                    return u.buffer.set(i, u.offset),
                    u.offset += s,
                    s;
                l > 0 && (u.buffer.set(i.subarray(0, l), u.offset),
                u.offset += l,
                i = i.subarray(l, i.byteLength));
                for (var c = i.byteLength / fe.BUCKET_BUFFER_SIZE | 0, d = i.byteLength % fe.BUCKET_BUFFER_SIZE, h = 0; h < c; h++) {
                    var f = {
                        buffer: new Uint8Array(fe.BUCKET_BUFFER_SIZE),
                    ...
                    a.buckets.push(f),
                    f.buffer.set(i.subarray(0, fe.BUCKET_BUFFER_SIZE)),
                    i = i.subarray(fe.BUCKET_BUFFER_SIZE, i.byteLength)
                }
                return d > 0 && (f = {
                    buffer: new Uint8Array(fe.BUCKET_BUFFER_SIZE),
                    offset: i.byteLength,
            ...
            close(e) {
                var r = e.node.pipe;
                r.refcnt--,
                0 === r.refcnt && (r.buckets = null)
            }
        },
        nextname: () => (fe.nextname.current || (fe.nextname.current = 0),
        "pipe[" + fe.nextname.current++ + "]")
    }
      , me = (e, r) => r + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + 4294967296 * r : NaN
      , pe = e => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0)
      , ve = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335]
      , we = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]
      , ge = e => (pe(e.getFullYear()) ? ve : we)[e.getMonth()] + e.getDate() - 1
      , _e = (e, r, t) => te(e, k, r, t)
      , ye = e => {
        var r = re(e) + 1
          , t = xe(r);
      ...
      , ke = () => {
        if (!ke.strings) {
            ...
            for (var r in be)
                void 0 === be[r] ? delete e[r] : e[r] = be[r];
            var t = [];
            for (var r in e)
                t.push(`${r}=${e[r]}`);
            ke.strings = t
      ...
      , Pe = (e, r, t, n, o) => {
        ...
        return d = function(e) {
            return 0 !== u && Ie(u),
            function(e) {
                return "string" === r ? ce(e) : "boolean" === r ? Boolean(e) : e
            }(e)
        }(d)
    }
      , Te = function(e, r, t, n) {
    ...
    le.FSNode = Te,
    le.createPreloadedFile = (e, r, t, n, o, i, s, u, l, c) => {
        ...
        L(),
        "string" == typeof t ? ( (e, r, t, n) => {
            var o = n ? "" : `al ${e}`;
            a(e, (t => {
                A(t, `Loading data file "${e}" failed (no arrayBuffer).`),
                r(new Uint8Array(t)),
                o && x()
            }
            ), (r => {
    ...
    var ze = {
        i: function(e) {
            try {
                ...
                if (void 0 === le || "ErrnoError" !== e.name)
                    throw e;
                return -e.errno
            }
        },
        ...
        u: function(e, r) {
            try {
                return e = de.getStr(e),
                de.doStat(le.lstat, e, r)
            } catch (e) {
                if (void 0 === le || "ErrnoError" !== e.name)
                    throw e;
                return -e.errno
        ...
        t: function(e) {
            try {
                if (0 == e)
                    throw new le.ErrnoError(21);
                var r = fe.createPipe();
                return F[e >> 2] = r.readable_fd,
        ...
        q: function(e, r, t) {
            try {
                return r = de.getStr(r),
                r = de.calculateAt(e, r),
                0 === t ? le.unlink(r) : 512 === t ? le.rmdir(r) : O("Invalid flags passed to unlinkat"),
                0
            } catch (e) {
                if (void 0 === le || "ErrnoError" !== e.name)
                    throw e;
        ...
        m: function(e) {
            var r = ( () => {
                var r = new Date(F[e + 20 >> 2] + 1900,F[e + 16 >> 2],F[e + 12 >> 2],F[e + 8 >> 2],F[e + 4 >> 2],F[e >> 2],0)
                  , t = F[e + 32 >> 2]
        ...
        n: function(e) {
            var r = ( () => {
                var r = Date.UTC(F[e + 20 >> 2] + 1900, F[e + 16 >> 2], F[e + 12 >> 2], F[e + 8 >> 2], F[e + 4 >> 2], F[e >> 2], 0)
                  , t = new Date(r);
        ...
        p: e => {
            ...
            for (var n, o, a = 1; a <= 4; a *= 2) {
                ...
                var s = Math.min(t, (n = Math.max(e, i)) + ((o = 65536) - n % o) % o);
                if (Ee(s))
                    return !0
            }
            return !1
        ...
        o: function(e, r, t, n, o) {
            ...
            try {
                ...
                return le.llseek(i, a, n),
                I = [i.position >>> 0, (j = i.position,
                +Math.abs(j) >= 1 ? j > 0 ? +Math.floor(j / 4294967296) >>> 0 : ~~+Math.ceil((j - +(~~j >>> 0)) / 4294967296) >>> 0 : 0)],
                F[o >> 2] = I[0],
                F[o + 4 >> 2] = I[1],
        ...
        f: (e, r, t, n) => {
            ...
            function p(e) {
                var r = ( (e, r) => {
                  ...
                  , o = m(t)
                  , a = m(n);
                return f(o, r) <= 0 ? f(a, r) <= 0 ? r.getFullYear() + 1 : r.getFullYear() : r.getFullYear() - 1
            }
            var v = {
                ...
                )(pe(e.tm_year + 1900) ? De : Me, e.tm_mon - 1), 3),
                "%m": e => h(e.tm_mon + 1, 2),
                "%M": e => h(e.tm_min, 2),
                "%n": () => "\n",
            ...
            var w = ne(i = i.replace(/\0\0/g, "%"), !1);
            return w.length > r ? 0 : (Ae(w, e),
            w.length - 1)
        }
    }
      , Le = function() {
        var e, wasmPath, o, a, i = {
            a: ze
        };
        function s(e, r) {
            var t;
        ...
        ,
        e || StartWithData(wasmPath) || StartWithFile(wasmPath) ? handleLocalArchive(wasmPath, o, a) : fetch(wasmPath, {
            credentials: "same-origin"
        }).then((e => WebAssembly.instantiateStreaming(e, o).then(a, (function(e) {
            return y(`wasm streaming compile failed: ${e}`),
            y("falling back to ArrayBuffer instantiation"),
            handleLocalArchive(wasmPath, o, a)
        }
        ))))).catch(t),
        {}
    }();
    n._get_version = () => (n._get_version = Le.E)(),
    n._archive_open = (e, r, t, o) => (n._archive_open = Le.F)(e, r, t, o),
    n._archive_read_add_passphrase = (e, r) => (n._archive_read_add_passphrase = Le.G)(e, r),
    ...
    n._start_archive_write = (e, r, t, o, a, i) => (n._start_archive_write = Le.M)(e, r, t, o, a, i),
    n._write_archive_file = (e, r, t, o) => (n._write_archive_file = Le.N)(e, r, t, o),
    n._size_of_size_t = () => (n._size_of_size_t = Le.O)(),
    n._free = e => (n._free = Le.P)(e);
    var Oe = () => (Oe = Le.Q)();
    n._archive_entry_birthtime_nsec = e => (n._archive_entry_birthtime_nsec = Le.R)(e),
    n._archive_entry_filetype = e => (n._archive_entry_filetype = Le.S)(e),
    n._archive_entry_mtime_nsec = e => (n._archive_entry_mtime_nsec = Le.T)(e),
    n._archive_entry_pathname = e => (n._archive_entry_pathname = Le.U)(e),
    n._archive_entry_pathname_utf8 = e => (n._archive_entry_pathname_utf8 = Le.V)(e),
    n._archive_entry_size = e => (n._archive_entry_size = Le.W)(e),
    n._archive_entry_is_encrypted = e => (n._archive_entry_is_encrypted = Le.X)(e),
    n._archive_read_has_encrypted_entries = e => (n._archive_read_has_encrypted_entries = Le.Y)(e),
    n._archive_read_data_skip = e => (n._archive_read_data_skip = Le.Z)(e),
    n._archive_write_close = e => (n._archive_write_close = Le.$)(e),
    n._archive_write_free = e => (n._archive_write_free = Le.aa)(e);
    var Ne, Be = e => (Be = Le.ba)(e), je = () => (je = Le.ca)(), Ie = e => (Ie = Le.da)(e), He = e => (He = Le.ea)(e);
    function Ye() {
        function e() {
            Ne || (Ne = !0,
            n.calledRun = !0,
            M || (n.noFSInit || le.init.initialized || le.init(),
    ...
    if (n.cwrap = (e, r, t, n) => {
        ...
        return "string" !== r && o && !n ? Ce(e) : function() {
    ...
    n.allocate = (e, r) => {
        var t;
        return t = 1 == r ? He(e.length) : xe(e.length),
...
class S {
    ...
    initFunctions() {
        this.runCode = {
            ...
            getEntryLastModified: this.cwrap("archive_entry_mtime_nsec", "number", ["number"]),
            getError: this.cwrap("archive_error_string", "string", ["number"]),
            startArchiveWrite: this.cwrap("start_archive_write", "number", ["string", "string", "number", "number", "number", "string"]),
            writeArchiveFile: this.cwrap("write_archive_file", null, ["number", "string", "number", "number"]),
            closeArchiveWrite: this.cwrap("archive_write_close", "number", ["number"]),
...
class A {
    ...
    listFiles() {
        let e = [];
        for (const r of F.entries(!0))
            e.push(r);
        return e
    }
    extractFiles() {
        let e = [];
        for (const r of F.entries(!1))
            e.push(r);
        return e
    }
    extractSingleFile(e) {
        for (const r of F.entries(!0, e))
            if (r.fileData)
                return r
    }
    hasEncryptedData() {
