...
function addDeleteButton(iManager) {
  ...
  deleteButton.onclick = () => {
    const modName = document.getElementById(
      "editDialog-mod-info-name",
    ).innerHTML;
...
module.exports = {
  ...
  init(iManager) {
    ...
    const useRecycleBin = {
      ...
      description:
        "If true, the mod will be moved to a recycle bin under the mod source path",
      t_description: {
