...
---`
        ...
        pluginData.push({
            ...
            description: 'When enabled: Updates mod categories from GameBanana. When disabled: Skips category updates',
            t_displayName: {
                zh_cn: '更新分类',
        ...
        pluginData.push({
            ...
            description: 'When enabled: Updates mod authors from GameBanana. When disabled: Skips author updates',
            t_displayName: {
                zh_cn: '更新作者',
                en: 'Update Authors'
            },
        ...
        pluginData.push({
            ...
            description: 'When enabled: Only updates missing/unknown values. When disabled: Forces update of all selected fields',
            t_displayName: {
                zh_cn: '智能更新模式',
        ...
        const confirmUpdate = {
            ...
            description: 'Step 1: Enable this safety lock. Step 2: Click update button. Lock auto-disables after update',
            t_displayName: {
                zh_cn: '安全锁',
                en: 'Safety Lock'
            },
        ...
        pluginData.push({
            ...
            description: 'Get latest information from GameBanana (requires safety lock)',
            t_displayName: {
                zh_cn: '开始更新',
                en: 'Start Update'
            },
            ...
            onChange: async () => {
                ...
                const updateCategories = iManager.getPluginData(pluginName, 'updateCategories');
                const updateAuthors = iManager.getPluginData(pluginName, 'updateAuthors');
                const onlyUpdateUnknown = iManager.getPluginData(pluginName, 'onlyUpdateUnknown');
                ...
                try {
                    for (const mod of iManager.data.modList) {
                        try {
                            ...
                            if (!mod.url || mod.url === "" || mod.url === "no url" || mod.url === "unknow" || !mod.url.includes("gamebanana.com")) {
                                skipCount++;
                                continue;
                            }
                            ...
                            if (updateCategories) {
                                const needsCategoryUpdate = !onlyUpdateUnknown || !mod.category || mod.category === "unknow" || mod.category === "";
                            ...
                            if (updateAuthors) {
                                const needsAuthorUpdate = !onlyUpdateUnknown || !mod.author || mod.author === "unknow" || mod.author === "";
